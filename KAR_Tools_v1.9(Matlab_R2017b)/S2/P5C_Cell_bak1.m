...
%         Part1_T=A_offset1((k3+k4+k20)/3);
%         Part2_T=A_offset1((k8+k10+k12)/3);
%         Part3_T=A_offset1((k9+k11+k13)/3);
%         Part4_T=A_offset1((k14+k16+k18)/3);
%         Part5_T=A_offset1((k15+k17+k19)/3);
...
%         Part1{i}(j,:)=[mean(Part1_C),var(Part1_C),mean(Part1_T),var(Part1_T)];
%         Part2{i}(j,:)=[mean(Part2_C),var(Part2_C),mean(Part2_T),var(Part2_T)];
%         Part3{i}(j,:)=[mean(Part3_C),var(Part3_C),mean(Part3_T),var(Part3_T)];
%         Part4{i}(j,:)=[mean(Part4_C),var(Part4_C),mean(Part4_T),var(Part4_T)];
%         Part5{i}(j,:)=[mean(Part5_C),var(Part5_C),mean(Part5_T),var(Part5_T)];
