...
%         Part1{i}(j,:)=[mean(Part1_T),var(Part1_T),max(Part1_T),min(Part1_T)];
%         Part2{i}(j,:)=[mean(Part2_T),var(Part2_T),max(Part2_T),min(Part2_T)];
%         Part3{i}(j,:)=[mean(Part3_T),var(Part3_T),max(Part3_T),min(Part3_T)];
%         Part4{i}(j,:)=[mean(Part4_T),var(Part4_T),max(Part4_T),min(Part4_T)];
%         Part5{i}(j,:)=[mean(Part5_T),var(Part5_T),max(Part5_T),min(Part5_T)];               
% % 第一层平均识别率为： 0.94
% % 第一层最大识别率为： 0.99
% % 第一层最小识别率为： 0.83 
...
%         Part1{i}(j,:)=[mean(Part1_T),var(Part1_T),...
%              range(Part1_T),kurtosis(Part1_T)];
%         Part2{i}(j,:)=[mean(Part2_T),var(Part2_T),...
%              range(Part2_T),kurtosis(Part2_T)];
%         Part3{i}(j,:)=[mean(Part3_T),var(Part3_T),...
%              range(Part3_T),kurtosis(Part3_T)];
%         Part4{i}(j,:)=[mean(Part4_T),var(Part4_T),...
%              range(Part4_T),kurtosis(Part4_T)];
%         Part5{i}(j,:)=[mean(Part5_T),var(Part5_T),...
%              range(Part5_T),kurtosis(Part5_T)];          
% % 第一层平均识别率为： 0.94
% % 第一层最大识别率为： 1.00
% % 第一层最小识别率为： 0.86       
...
%         Part1{i}(j,:)=[mean(Part1_T),var(Part1_T),skewness(Part1_T),kurtosis(Part1_T),...
%              range(Part1_T),Part1_T_DC];
%         Part2{i}(j,:)=[mean(Part2_T),var(Part2_T),skewness(Part2_T),kurtosis(Part2_T),...
%              range(Part2_T),Part2_T_DC];
%         Part3{i}(j,:)=[mean(Part3_T),var(Part3_T),skewness(Part3_T),kurtosis(Part3_T),...
%              range(Part3_T),Part3_T_DC];
%         Part4{i}(j,:)=[mean(Part4_T),var(Part4_T),skewness(Part4_T),kurtosis(Part4_T),...
%              range(Part4_T),Part4_T_DC];
%         Part5{i}(j,:)=[mean(Part5_T),var(Part5_T),skewness(Part5_T),kurtosis(Part5_T),...
%              range(Part5_T),Part5_T_DC];
% % 第一层平均识别率为： 0.95
% % 第一层最大识别率为： 1.00(2)
% % 第一层最小识别率为： 0.86             
