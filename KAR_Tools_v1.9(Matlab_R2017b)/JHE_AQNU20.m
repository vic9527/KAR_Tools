...
%% Step.1 -- 导入数据
addpath(genpath(pwd));
MSRAction3D=['..\\..\\KAR_DataSets\\AQNU_SkeletonAction\\AQNU20\\'];
All_Actions=LoadData_AQNU20(MSRAction3D);
clearvars this_dir MSRAction3D
All_Actions=SetLabel_AQNU20(All_Actions);
...
%% Step.2 -- 提取特征
%第一层：
TR_FV1st=P5C_Cell_AQNU20(TR_data);
TE_FV1st=P5C_Cell_AQNU20(TE_data);
...
%第二层特征：
TR_FV2nd=RPRO_Cell_AQNU20(TR_data);
TE_FV2nd=RPRO_Cell_AQNU20(TE_data);
% 转化成Struct格式
TR_FV2nd_Struct={};
