...
% % % TZ_Cls_Max=max(TZ_Cls_one);
% % % TZ_Cls_Min=min(TZ_Cls_one);
% % % TZ_Cls_Mean=mean(TZ_Cls_one);
% % % TZ_Cls_Var=var(TZ_Cls_one);
% % % TZ_Cls_Amp=TZ_Cls_Max-TZ_Cls_Min;
% % % TZ_Cls(jj,:)=[TZ_Cls_Max,TZ_Cls_Mean,TZ_Cls_Var,TZ_Cls_Amp];

 clearvars -except Bag kk2 b TZ_Cls
% % % CLS_kp1=k9-k2;
% % % CLS_kp2=k11-k2;
% % % CLS_kp3=k13-k2;
...
% % % % % % % Lkp6=k9-k2;
% % % % % % % 
% % % % % % % norm_Lkp4=sqrt(sum(Lkp4.^2,2));
% % % % % % % norm_Lkp5=sqrt(sum(Lkp5.^2,2));
% % % % % % % norm_Lkp6=sqrt(sum(Lkp6.^2,2));
% % % % % % % 
% % % % % % % LE_IA=acosd((dot(Lkp5,Lkp6,2))/(norm_Lkp5.*norm_Lkp6));
% % % % % % % 
% % % % % % % LE_IA_Amp=max(LE_IA)-min(LE_IA);
% % % % % % % LE_IA_Max=max(LE_IA);
% % % % % % % LE_IA_Min=min(LE_IA);
% % % % % % % LE_IA_Mean=mean(LE_IA);
% % % % % % % LE_IA_Var=var(LE_IA);
% % % % % % % 
% % % % % % % % LE_DA
% % % % % % % 
% % % % % % % Lkp(jj,:)=[LE_IA_Amp,LE_IA_Max,LE_IA_Min,LE_IA_Mean,LE_IA_Var];
...
% Lkp=[Lkp4,Lkp5,Lkp6,Lkp7];
% 
% Lkp_onearm_mean(jj,:)=mean((Lkp));
% Lkp_onearm_var(jj,:)=var((diff(Lkp)));
% 
% Lkp_onearm=[Lkp_onearm_mean,Lkp_onearm_var];
...
%   Lkp_XL=Lkp_all;
%   
   clearvars -except VK_LR_XL Lkp_XL Lkp_onearm Lkp TZ_Cls
