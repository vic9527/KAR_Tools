...
for i = 2:Asize
VRL_Z(i-1,:)=abs(Part5_C(i,:)-Part5_C(1,:));
end


VRL_Z_Mean=mean(VRL_Z);
VRL_Z_Var=var(VRL_Z);


Part5_VRL(jj,:)=[VRL_Z_Mean,VRL_Z_Var];

 clearvars -except Bag_LR kk1 Part5_VRL
