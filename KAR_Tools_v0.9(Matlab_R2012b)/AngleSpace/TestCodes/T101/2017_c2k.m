...
% % % vk1st=[vk(:,1:3),vk(:,4:6),vk(:,7:9)];
% % % vk2nd=[vk(:,10:12),vk(:,13:15),vk(:,16:18),vk(:,19:21)];
% % % vk3rd=[vk(:,22:24),vk(:,25:27),vk(:,28:30),vk(:,31:33)];
% % % vk4th=[vk(:,34:36),vk(:,37:39),vk(:,40:42),vk(:,43:45)];
% % % vk5th=[vk(:,46:48),vk(:,49:51),vk(:,52:54),vk(:,55:57)];
...
id=randperm(257,27);
test_A=A1(id,:);
test_A_labels=train_TZJ_labels(id,1);
B1=A1;
B2=train_TZJ_labels;
% B1(id,:)=[];
% B2(id,:)=[];
