...
verbose = 1;  
All_data_dir = ['E:\HAR\StudyWork\SW1.0\T7\AQNU-A30\A20\'];

%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Step.2 -- Load all data
fprintf('Loading all data:\n');
All_Actions = loadDataA20(All_data_dir, verbose);
...
clearvars -except All_Actions indices kk T TT  MeanCaccuracy Finaccuracy StdFA CaccuracyBag 
...
clearvars -except All_Actions indices kk Caccuracy Cbag CaccuracyBag CPRPbag  T TT MeanCaccuracy Finaccuracy StdFA

end

CaccuracyBag(:,T)=Caccuracy';
