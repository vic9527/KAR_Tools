...
% % %  end   
            ...
            clearvars -except All_Actions indices kk Caccuracy Cbag CaccuracyBag CPRPbag  T TT MeanCaccuracy Finaccuracy StdFA TTCaccuracy TTCbag TTCPRPbag
...
%             TTCPRPbag(:,T)=CPRPbag';
            ...
            MeanCaccuracy(T)=mean(Caccuracy);
            % Finaccuracy=sprintf('%2.8f%%', (MeanCaccuracy)*100)

            StdFA(T)=std(Caccuracy);
