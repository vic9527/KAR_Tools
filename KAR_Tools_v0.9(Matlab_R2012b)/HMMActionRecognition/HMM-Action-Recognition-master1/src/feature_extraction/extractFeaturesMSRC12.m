function Features = extractFeaturesMSRC12(file)
...
all(A == 0,2);%选出所有零行，并用logical向量表示 
A(all(A == 0,2),:) = []; %全零行设为空，即可去掉 
...
TP1=(k4-k1)/TP_lenNorm;
TP2=(k8-k5)/TP_lenNorm;
TP3=(k12-k9)/TP_lenNorm;
TP4=(k16-k13)/TP_lenNorm;
TP5=(k20-k17)/TP_lenNorm;


Part1_CV=(k1+k2+k3)/3-k1;
Part2_CV=(k5+k6+k7)/3-k5;
Part3_CV=(k9+k10+k11)/3-k9;
Part4_CV=(k13+k14+k15)/3-k13;
Part5_CV=(k17+k18+k19)/3-k17;
